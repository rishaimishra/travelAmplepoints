                  ...
                  <tr class="odd"> 
                    ...
                    @if($data->status=='inactive')<span class="badge bg-success">{{$data->status}}@endif</span></td>
                     ...
                     <td><div class="btn-group btn-group-sm">
                        <a href="add-page/{{$data->id}}" class="btn btn-info"><i class="fas fa-edit"></i></a>&nbsp;
                        <a href="add-page/{{$data->id}}" class="btn btn-success"><i class="fas fa-eye"></i></a>&nbsp;
                      </div></td>
                  </tr>@php $i++; @endphp
                  @endforeach
                  </tbody>
                  <tfoot> 
                  <tr><th rowspan="1" colspan="1">SN</th><th rowspan="1" colspan="1">Page ID</th><th rowspan="1" colspan="1">Name</th><th rowspan="1" colspan="1">Title</th><th rowspan="1" colspan="1">Type</th><th rowspan="1" colspan="1">Type Name</th><th rowspan="1" colspan="1">Status</th><th rowspan="1" colspan="1">Date Time</th><th rowspan="1" colspan="1">Action</th></tr>
                  </tfoot>
                </table></div></div></div>
              </div>
              <!-- /.card-body -->
