...
@include('admin.nav')
  ...
  @php 
    ...
    $CityCode='';
    $CityName='';
    $CountryCode=''; $CountryName=''; $CurrencyCode=''; $image=''; $content=''; $priority=''; 
    
  if(isset($citySingel)){ 
       $id=$citySingel->id; 
       $AirportCode=$citySingel->AirportCode; 
       $AirportName=$citySingel->AirportName; 
       $CityCode=$citySingel->CityCode; 
       $CityName=$citySingel->CityName;
       $CountryCode=$citySingel->CountryCode; 
       $CountryName=$citySingel->CountryName;        
       $CurrencyCode=$citySingel->CurrencyCode; 
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Add/Update Flight City</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Add/Update Flight City</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <form action="{{ asset('flight-city-post') }}" method="post" enctype="multipart/form-data">
  @csrf
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Flight City  </h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
              <div class="card-body">
              <div class="row">   
                ...
                <div class="form-group col-md-3">
                  <label for="exampleInputEmail1">Airport Code</label>
                  <input type="text" name="AirportCode" value="{{$AirportCode}}" id="AirportCode" class="form-control" readonly="readonly" placeholder="DEL" required>
                  <div class="input-box from_list" style="display:none"></div>
                </div>
                <div class="form-group col-md-3">
                  <label for="exampleInputEmail1">Airport Name</label>
                  <input type="text" name="AirportName" value="{{$AirportName}}" class="form-control" id="AirportName" readonly="readonly" placeholder="Delhi" required>
                   <div class="input-box to_list" style="display:none"></div>
                </div>                
                
                <div class="form-group col-md-3">
                  <label for="exampleInputEmail1">City Code</label>
                  <input type="text" name="CityCode" value="{{$CityCode}}" class="form-control" readonly="readonly" placeholder="DEL" required>
                </div>
                
                <div class="form-group col-md-3">
                  <label for="exampleInputEmail1">City Name</label>
                  <input type="text" name="CityName" value="{{$CityName}}" class="form-control" readonly="readonly" placeholder="DELHI" required> 
                </div>
                ...
                <div class="form-group col-md-3">
                  ...
                  <input type="text" name="CountryName" value="{{$CountryName}}" class="form-control" readonly="readonly" placeholder="INDIA" required>
                </div>
                
                <div class="form-group col-md-3">
                  <label for="exampleInputEmail1">Currency Code </label>
                  <input type="text" name="CurrencyCode" value="{{$CurrencyCode}}" class="form-control" readonly="readonly" placeholder="INR" required>
                </div>
