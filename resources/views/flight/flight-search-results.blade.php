...
innerHtml+=`<div class="card-item flight-card flight--card card-item-list card-item-list-2">
    ...
    <div class="card-body"><div class="card-top-title d-flex justify-content-between">

        <div style="color: black"><h3 class="card-title font-size-17">${tripType}</h3>
    ...
    <div style="text-align: center" class="flight-details py-3">
        ...
        <div class="flight-time pb-3"><div class="flight-time-item d-flex c-div-0">
            ...
            <div class="c-div-6">
                ...
                <h6 class="">
                    ...
                    <div class="card-price" style="text-align: right; padding: 0">

                        <span class="price_from" style="display: none">From </span>

                        <span class="pricenum" style="color: #f75b10; display: none">

                            <b>{{$currency_symbol}}${$price.toLocaleString()}</b>

                        </span>

                        <span style="color: #f75b10; font-size: 24px">FREE</span>

                        <span style="font-size: 24px">WITH </span>

                        <span class="price_num" style="color: #f75b10; font-size: 24px">

                            <b>${parseInt(data.result[i].free)}</b>
                        ...
                        <span class="span-1476" style="font-size: 24px;color: #f75b10;">
     ...
     ${data.result[i].isReturn == 'Yes' ?
       ...
       `<div class="flight-time-item d-flex c-div-0">
            ...
            <div class="div-1496 col-md-9 col-12" style="line-height: 25px; padding: 20px 10px 0">
