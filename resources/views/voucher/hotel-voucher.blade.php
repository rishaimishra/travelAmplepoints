...
if(isset($book_response["booking"])){
	$Roomnamexml = $book_response["booking"]["hotel"]["rooms"][0]["name"];
	if(isset($book_response["booking"]["hotel"]["rooms"][0]["rates"][0]["rateComments"])){
		$room_Descriptionsz = $book_response["booking"]["hotel"]["rooms"][0]["rates"][0]["rateComments"];
	}else{ $room_Descriptionsz=''; }
	$boardName = $book_response["booking"]["hotel"]["rooms"][0]["rates"][0]["boardName"];
	$cancellationPolicies = $book_response["booking"]["hotel"]["rooms"][0]["rates"][0]["cancellationPolicies"];
	
	$cancellationPolicy = "Free cancellation before ".$cancellationPolicies[0]['from'];
	$room_name = $book_response["booking"]["hotel"]["rooms"][0]['name'];
}else {$Roomnamexml=''; $room_Descriptionsz=''; $boardName=''; $cancellationPolicies=''; $cancellationPolicy=''; $room_name=''; }
