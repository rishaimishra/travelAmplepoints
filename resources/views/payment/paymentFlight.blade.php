...
$total_amount = round($orderDetail->prices);
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2 my_frm_cntr">
                                        <div class="reg_frm_container">
                                            ...
                                            <legend>Payment For Flight Order No: {{ $order_id }}</legend>
...
<script>
    ...
    async function initialize() {
        const {clientSecret} = await fetch("<?php echo $baseurl; ?>/createstrippayment/flight", {
            method: "POST",
        ...
        const {error} = await stripe.confirmPayment({
            ...
            confirmParams: {
                // Make sure to change this to your payment completion page
                 return_url:"{{route('stripeorderstatus_flight',['order_id' => $order_id, 'customer_id' => $customer_id])}}",
