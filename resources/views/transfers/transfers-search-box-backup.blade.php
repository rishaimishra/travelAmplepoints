                                    ...
                                    <div class="col-lg-4 pr-0">
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control autosuggestion_transfer"  name="city_name" id="city_name_transfer" type="text" value="<?php echo $city_name;  ?>" placeholder="Enter city or property">
                                            </div>
                                        </div>
					   ...
					   $.ajax({
								...
								success: function (data) { var data=data.zonegroup;
									...
									for(var i=0;i<data.length;i++){
				                        ...
				                        innerHtml +='<li  class="iataAKM" countryCode="'+data[i].countryCode+'" destinationCode="'+data[i].destinationCode+'" destinationName="'+destinationName+'" style="cursor: pointer;">'+destinationName+'</li>';
									}
									 innerHtml +='</ul>';
