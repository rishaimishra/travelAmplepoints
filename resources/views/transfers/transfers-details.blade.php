...
<div class="video-bg" style="background:url({{$images[0]['urls'][$img]['resource']}});background-size: cover;">
</div>
                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-btn">
                        <div class="btn-box">
                           ...
                           <a class="theme-btn" data-src="<?php echo $images[0]['urls'][$img]['resource'];  ?>"
                    ...
                    <?php  for($i=1;$i<count($images);$i++){ ?>
                        <a class="d-none"
                             data-fancybox="hotel-single-main-gallery"
                             data-src="<?php echo $images[$i]['urls'][4]['resource'];  ?>"
