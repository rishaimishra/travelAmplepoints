                                    ...
                                    <div class="col-lg-3 pr-0">
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control autosuggestion_tours" name="city_code" id="city_code" type="hidden" value="<?php echo $city_code;  ?>" >
                                                <input class="form-control autosuggestion_tours"  name="city_name" id="city_name" type="text" value="<?php echo $city_name;  ?>" placeholder="Enter city or property">
                                            </div>
                                        </div>
        ...
        <script type="text/javascript">
					   ...
					   $.ajax({
								...
								success: function (data) { var data=data.zonegroup;
									...
									for(var i=0;i<data.length;i++){
										destinationName=data[i].destinationName+", "+data[i].countryName; 
				                        innerHtml +='<li  class="iataAKM" destinationCode="'+data[i].destinationCode+'" destinationName="'+destinationName+'" style="cursor: pointer;">'+destinationName+'</li>';
									}
									 innerHtml +='</ul>';
			 ...
			 function iata() {  
					 jQuery(".iataAKM").click(function(){
							...
							document.getElementById("city_name").value = destinationName;
