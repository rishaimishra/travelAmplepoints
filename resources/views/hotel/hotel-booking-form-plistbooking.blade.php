        ...
        <div class="form-box">
          ...
          <div class="form-content">
            <div class="contact-form-action">
              <form method="post" action="{{ asset('hotel-final-checkout-plistbooking') }}">
              @csrf
                ...
                <input class="form-control" type="hidden" name="roomid" id="roomid" value="<?php echo $roomid; ?>">
                ...
                <div class="row">
                    ...
                    <div class="input-box">
                      ...
                      <div class="form-group"> 
                        <div class="select-contain w-auto">
                          <select class="select-contain-select" name="passenger[adult][title][<?php echo $r; ?>][]">
                  ...
                  <div class="col-lg-4 responsive-column">
                    <div class="input-box">
                      <label class="label-text">Document ID</label>
                      <div class="form-group"> 
                        <div class="select-contain w-auto">
                          <input class="form-control" type="text" name="passenger[child][id][<?php echo $r; ?>][]" placeholder="ID">
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="card-item shadow-none radius-none mb-0">
              ...
              <div class="card-body p-0">
                ...
                <ul class="list-items list-items-2 pt-3 price_details">
                  <!--<li><span>Base Fare:</span><span class="base_fare"><?php echo $currency_symbol." ".$hotelSearchData->base_price;?></span></li>
                  <li><span>Taxes And Fees:</span><span class="tax"><?php echo $currency_symbol;  ?> </span></li>-->
                  <li><span>Total Price:</span><span class="total_amount"><?php echo $currency_symbol." ".$hotelSearchData->lowRate; ?></span></li>
                </ul>
              </div>
            </div>
            <!-- end card-item -->
