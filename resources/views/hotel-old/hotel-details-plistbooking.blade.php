...
$images=array(); 
$room_details=json_decode($hotelSearchData->room_details,true); $images=$room_details[0]['property_images'];    ?>
                ...
                <div class="col-lg-8">
                    <div class="single-content-wrap padding-top-60px">
                        <div id="description" class="page-scroll">
                            ...
                            <p class="py-3 roomDetailDescription" style="text-align: justify;">{{ $hotelSearchData->promoDescription; }}</p>
                            @for($i=0;$i<count($room_details);$i++) 
                            <p class="py-3 roomDetailDescription" style="text-align: justify;">{{$room_details[$i]['post_content']}}</p>
                            @endfor
                        ...
                        <div id="availability" class="page-scroll">
                               ...
                               @for($i=0;$i<count($room_details);$i++) 
                                <div class="cabin-type padding-top-30px">
                                     <div class="cabin-type-item seat-selection-item d-flex">
                                      <div class="" style="border: 1px solid rgba(128, 137, 150, 0.2);">
                                       <h3 class="title" style="background-color:rgba(128, 137, 150, 0.2); padding:5px 15px;">{{$room_details[$i]['post_title']}}</h3>
                                       <div class="row" style="margin:0; border-top: 1px solid rgba(128, 137, 150, 0.2); margin-bottom: 5px;">
                                        <div class="col-lg-3 responsive-column" style="text-align: justify;">{{$room_details[$i]['post_title']}}</div>
                                        <div class="col-lg-3 responsive-column">{{$room_details[$i]['ID']}}</div> 
                                        <div class="col-lg-2 responsive-column"style="color:RED"> {{$room_details[$i]['availability']}} Room(s) Left</div>
                                        <div class="col-lg-2 responsive-column">
                                         <p class="text-uppercase font-size-14">Per/night<strong class="mt-n1 text-black font-size-18 font-weight-black d-block"><?php echo $currency_symbol; ?> {{$room_details[$i]['TotalFare']}}</strong></p>
                                        </div>
                                        <div class="col-lg-2 responsive-column cabin-price">
                                         <div class="custom-checkbox mb-0">
                                          <input style="display:none" type="radio" name="akm" id="selectChb'+i+''+j+'">
                                          <!--<label for="selectChb'+i+''+j+'" class="theme-btn theme-btn-small">Select</label>-->
                                          <a href="{{ asset("hotel-booking") }}/{{base64_encode($room_details[$i]['ID'])}}/<?php echo base64_encode($hotelSearchData->id); ?>" class="theme-btn theme-btn-small" style="width:100px; text-align:center; padding:0;">Book Now</a></div>
                                        </div>
                                       </div>
                                      </div>
                                     </div>
                            ...
                            @if($hotelSearchData->promoDescription!='')
                            <div class="section-block"></div>
                            <div class="single-content-item padding-top-40px padding-bottom-40px">
                            ...
                            <?php $PropertyAmenity=$room_details[0]['Amenities']; ?>
                                         	...
                                         	<div class="single-tour-feature d-flex align-items-center mb-3">
                                            	<div class="single-feature-icon icon-element ml-0 flex-shrink-0 mr-3">
                                                 ...
                                                 <div class="single-feature-titles">
                                                    <h3 class="title font-size-15 font-weight-medium">{{$PropertyAmenity[$i]}}</h3>
                                                </div>
                                            </div>
                                         </div>
									@endfor
